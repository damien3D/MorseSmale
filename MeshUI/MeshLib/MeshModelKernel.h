...
{
private:
    PolyIndexArray  m_Index;    // Edge vertex-index array
    ...
    int m_nHalfEdges;
        IntArray                m_AdjFaces; // Edge adj-faces array
...
public:
    ...
    FlagArray& GetFlag() { return m_Flag; }
        ...
        IntArray& GetAdjFace() { return m_AdjFaces;}
...
private:
    ...
    string  m_FileName; // File name of the mesh model (Path + Tiltle + Ext)
